#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~#
#Bootstrapping of the Response ratio in Richness Species
#Clear memory
rm(list=ls())
...
#Exclude the forest with zero richness (the RRR can't be calculated), and the OGF data
data1<-subset(mydata,RRR!="NA")
...
for(kk in 1:R){
  boot.sample <- sample(AmES$RRR, replace = TRUE)
...
for(kk in 1:R){
  boot.sample <- sample(AmYSF$RRR, replace = TRUE)
...
for(kk in 1:R){
  boot.sample <- sample(AmMSF$RRR, replace = TRUE)
...
for(kk in 1:R){
  boot.sample <- sample(ReES$RRR, replace = TRUE)
...
for(kk in 1:R){
  boot.sample <- sample(ReYSF$RRR, replace = TRUE)
...
for(kk in 1:R){
  boot.sample <- sample(ReMSF$RRR, replace = TRUE)
...
for(kk in 1:R){
  boot.sample <- sample(ReOSF$RRR, replace = TRUE)
...
for(kk in 1:R){
  boot.sample <- sample(BiES$RRR, replace = TRUE)
...
for(kk in 1:R){
  boot.sample <- sample(BiYSF$RRR, replace = TRUE)
...
for(kk in 1:R){
  boot.sample <- sample(BiMSF$RRR, replace = TRUE)
...
for(kk in 1:R){
  boot.sample <- sample(BiOSF$RRR, replace = TRUE)
  B12[kk] <- mean(boot.sample)
}
boxplot(B12)
quantile(B12,c(0.025,0.975))
hist(B12, breaks = 30)
dB12<-c(Bmean=mean(B12),quantile(B12,c(0.025,0.975)),n=nrow(BiOSF))
dB12
...
for(kk in 1:R){
  boot.sample <- sample(MaES$RRR, replace = TRUE)
...
for(kk in 1:R){
  boot.sample <- sample(MaYSF$RRR, replace = TRUE)
...
for(kk in 1:R){
  boot.sample <- sample(MaMSF$RRR, replace = TRUE)
...
for(kk in 1:R){
  boot.sample <- sample(MaOSF$RRR, replace = TRUE)
...
for(kk in 1:R){
  boot.sample <- sample(NAmES$RRR, replace = TRUE)
...
for(kk in 1:R){
  boot.sample <- sample(NAmYSF$RRR, replace = TRUE)
...
for(kk in 1:R){
  boot.sample <- sample(NAmMSF$RRR, replace = TRUE)
...
for(kk in 1:R){
  boot.sample <- sample(NReES$RRR, replace = TRUE)
...
for(kk in 1:R){
  boot.sample <- sample(NReYSF$RRR, replace = TRUE)
...
for(kk in 1:R){
  boot.sample <- sample(NReMSF$RRR, replace = TRUE)
...
for(kk in 1:R){
  boot.sample <- sample(NReOSF$RRR, replace = TRUE)
...
for(kk in 1:R){
  boot.sample <- sample(NBiES$RRR, replace = TRUE)
...
for(kk in 1:R){
  boot.sample <- sample(NBiYSF$RRR, replace = TRUE)
...
for(kk in 1:R){
  boot.sample <- sample(NBiMSF$RRR, replace = TRUE)
...
for(kk in 1:R){
  boot.sample <- sample(NMaES$RRR, replace = TRUE)
...
for(kk in 1:R){
  boot.sample <- sample(NMaYSF$RRR, replace = TRUE)
...
for(kk in 1:R){
  boot.sample <- sample(NMaMSF$RRR, replace = TRUE)
...
for(kk in 1:R){
  boot.sample <- sample(NMaOSF$RRR, replace = TRUE)
...
for(kk in 1:R){
  boot.sample <- sample(AuAmES$RRR, replace = TRUE)
...
for(kk in 1:R){
  boot.sample <- sample(AuAmMSF$RRR, replace = TRUE)
...
for(kk in 1:R){
  boot.sample <- sample(AuReES$RRR, replace = TRUE)
...
for(kk in 1:R){
  boot.sample <- sample(AuReYSF$RRR, replace = TRUE)
...
for(kk in 1:R){
  boot.sample <- sample(AuReMSF$RRR, replace = TRUE)
...
for(kk in 1:R){
  boot.sample <- sample(AuBiES$RRR, replace = TRUE)
...
for(kk in 1:R){
  boot.sample <- sample(AuBiYSF$RRR, replace = TRUE)
...
for(kk in 1:R){
  boot.sample <- sample(AuBiMSF$RRR, replace = TRUE)
...
for(kk in 1:R){
  boot.sample <- sample(AuMaES$RRR, replace = TRUE)
...
for(kk in 1:R){
  boot.sample <- sample(AuMaMSF$RRR, replace = TRUE)
...
for(kk in 1:R){
  boot.sample <- sample(IMAmYSF$RRR, replace = TRUE)
...
for(kk in 1:R){
  boot.sample <- sample(IMAmMSF$RRR, replace = TRUE)
...
for(kk in 1:R){
  boot.sample <- sample(IMReYSF$RRR, replace = TRUE)
...
for(kk in 1:R){
  boot.sample <- sample(IMReMSF$RRR, replace = TRUE)
...
for(kk in 1:R){
  boot.sample <- sample(IMBiYSF$RRR, replace = TRUE)
...
for(kk in 1:R){
  boot.sample <- sample(IMBiMSF$RRR, replace = TRUE)
...
for(kk in 1:R){
  boot.sample <- sample(IMMaYSF$RRR, replace = TRUE)
...
for(kk in 1:R){
  boot.sample <- sample(IMMaMSF$RRR, replace = TRUE)
...
for(kk in 1:R){
  boot.sample <- sample(AfAmYSF$RRR, replace = TRUE)
...
for(kk in 1:R){
  boot.sample <- sample(AfAmMSF$RRR, replace = TRUE)
...
for(kk in 1:R){
  boot.sample <- sample(AfBiES$RRR, replace = TRUE)
...
for(kk in 1:R){
  boot.sample <- sample(AfBiYSF$RRR, replace = TRUE)
...
AfBiOSF<-subset(data,BGroupBRealm=="AfrotropicBirdsOSF")
median(AfBiOSF$RRR)
nrow(AfBiOSF)
R<-10000
B76<-rep(0,R);#change the name of the Bootstrap object
for(kk in 1:R){
  boot.sample <- sample(AfBiOSF$RRR, replace = TRUE)
  B76[kk] <- mean(boot.sample)
}
boxplot(B76)
quantile(B76,c(0.025,0.975))
hist(B76, breaks = 30)
dB76<-c(Bmean=mean(B76),quantile(B76,c(0.025,0.975)),n=nrow(AfBiOSF))
dB76
...
for(kk in 1:R){
  boot.sample <- sample(AfMaYSF$RRR, replace = TRUE)
...
for(kk in 1:R){
  boot.sample <- sample(MoAmES$RRR, replace = TRUE)
...
for(kk in 1:R){
  boot.sample <- sample(MoAmYSF$RRR, replace = TRUE)
...
for(kk in 1:R){
  boot.sample <- sample(MoAmMSF$RRR, replace = TRUE)
...
for(kk in 1:R){
  boot.sample <- sample(MoReES$RRR, replace = TRUE)
...
for(kk in 1:R){
  boot.sample <- sample(MoReYSF$RRR, replace = TRUE)
...
for(kk in 1:R){
  boot.sample <- sample(MoReMSF$RRR, replace = TRUE)
...
for(kk in 1:R){
  boot.sample <- sample(MoReOSF$RRR, replace = TRUE)
...
for(kk in 1:R){
  boot.sample <- sample(MoBiES$RRR, replace = TRUE)
...
for(kk in 1:R){
  boot.sample <- sample(MoBiYSF$RRR, replace = TRUE)
...
for(kk in 1:R){
  boot.sample <- sample(MoBiMSF$RRR, replace = TRUE)
...
MoBiOSF<-subset(data,BGroupBiome=="1.TropMoBirdsOSF")
median(MoBiOSF$RRR)
nrow(MoBiOSF)
R<-10000
B92<-rep(0,R);#change the name of the Bootstrap object
for(kk in 1:R){
  boot.sample <- sample(MoBiOSF$RRR, replace = TRUE)
  B92[kk] <- mean(boot.sample)
}
boxplot(B92)
quantile(B92,c(0.025,0.975))
hist(B92, breaks = 30)
dB92<-c(Bmean=mean(B92),quantile(B92,c(0.025,0.975)),n=nrow(MoBiOSF))
dB92
...
for(kk in 1:R){
  boot.sample <- sample(MoMaES$RRR, replace = TRUE)
...
for(kk in 1:R){
  boot.sample <- sample(MoMaYSF$RRR, replace = TRUE)
...
for(kk in 1:R){
  boot.sample <- sample(MoMaMSF$RRR, replace = TRUE)
...
for(kk in 1:R){
  boot.sample <- sample(DrAmES$RRR, replace = TRUE)
...
for(kk in 1:R){
  boot.sample <- sample(DrAmYSF$RRR, replace = TRUE)
...
for(kk in 1:R){
  boot.sample <- sample(DrAmMSF$RRR, replace = TRUE)
...
for(kk in 1:R){
  boot.sample <- sample(DrReES$RRR, replace = TRUE)
...
for(kk in 1:R){
  boot.sample <- sample(DrReYSF$RRR, replace = TRUE)
...
for(kk in 1:R){
  boot.sample <- sample(DrReMSF$RRR, replace = TRUE)
...
for(kk in 1:R){
  boot.sample <- sample(DrBiYSF$RRR, replace = TRUE)
...
for(kk in 1:R){
  boot.sample <- sample(DrBiMSF$RRR, replace = TRUE)
...
for(kk in 1:R){
  boot.sample <- sample(DrMaES$RRR, replace = TRUE)
...
for(kk in 1:R){
  boot.sample <- sample(DrMaYSF$RRR, replace = TRUE)
...
for(kk in 1:R){
  boot.sample <- sample(DrMaMSF$RRR, replace = TRUE)
...
for(kk in 1:R){
  boot.sample <- sample(DrMaOSF$RRR, replace = TRUE)
...
for(kk in 1:R){
  boot.sample <- sample(SaAmES$RRR, replace = TRUE)
...
for(kk in 1:R){
  boot.sample <- sample(SaAmMSF$RRR, replace = TRUE)
...
for(kk in 1:R){
  boot.sample <- sample(SaReES$RRR, replace = TRUE)
...
for(kk in 1:R){
  boot.sample <- sample(SaReMSF$RRR, replace = TRUE)
...
for(kk in 1:R){
  boot.sample <- sample(SaBiES$RRR, replace = TRUE)
...
for(kk in 1:R){
  boot.sample <- sample(SaBiMSF$RRR, replace = TRUE)
...
for(kk in 1:R){
  boot.sample <- sample(SaMaES$RRR, replace = TRUE)
...
for(kk in 1:R){
  boot.sample <- sample(SaMaMSF$RRR, replace = TRUE)
...
for(kk in 1:R){
  boot.sample <- sample(CoAmES$RRR, replace = TRUE)
...
for(kk in 1:R){
  boot.sample <- sample(CoAmYSF$RRR, replace = TRUE)
...
for(kk in 1:R){
  boot.sample <- sample(CoAmMSF$RRR, replace = TRUE)
...
for(kk in 1:R){
  boot.sample <- sample(CoReES$RRR, replace = TRUE)
...
for(kk in 1:R){
  boot.sample <- sample(CoReYSF$RRR, replace = TRUE)
...
for(kk in 1:R){
  boot.sample <- sample(CoReMSF$RRR, replace = TRUE)
...
for(kk in 1:R){
  boot.sample <- sample(CoBiES$RRR, replace = TRUE)
...
for(kk in 1:R){
  boot.sample <- sample(CoBiYSF$RRR, replace = TRUE)
...
for(kk in 1:R){
  boot.sample <- sample(CoBiMSF$RRR, replace = TRUE)
...
nrow(CoBiOSF)
R<-10000
B140<-rep(0,R);#change the name of the Bootstrap object
for(kk in 1:R){
  boot.sample <- sample(CoBiOSF$RRR, replace = TRUE)
  B140[kk] <- mean(boot.sample)
}
boxplot(B140)
quantile(B140,c(0.025,0.975))
hist(B140, breaks = 30)
dB140<-c(Bmean=mean(B140),quantile(B140,c(0.025,0.975)),n=nrow(CoBiOSF))
dB140
...
for(kk in 1:R){
  boot.sample <- sample(CoMaOSF$RRR, replace = TRUE)
...
for(kk in 1:R){
  boot.sample <- sample(CoMaYSF$RRR, replace = TRUE)
...
for(kk in 1:R){
  boot.sample <- sample(CoMaMSF$RRR, replace = TRUE)
...
for(kk in 1:R){
  boot.sample <- sample(IsAmES$RRR, replace = TRUE)
...
for(kk in 1:R){
  boot.sample <- sample(IsAmYSF$RRR, replace = TRUE)
...
for(kk in 1:R){
  boot.sample <- sample(IsAmMSF$RRR, replace = TRUE)
...
for(kk in 1:R){
  boot.sample <- sample(IsReES$RRR, replace = TRUE)
...
for(kk in 1:R){
  boot.sample <- sample(IsReYSF$RRR, replace = TRUE)
...
for(kk in 1:R){
  boot.sample <- sample(IsReMSF$RRR, replace = TRUE)
...
for(kk in 1:R){
  boot.sample <- sample(IsReOSF$RRR, replace = TRUE)
...
for(kk in 1:R){
  boot.sample <- sample(IsBiES$RRR, replace = TRUE)
...
for(kk in 1:R){
  boot.sample <- sample(IsBiYSF$RRR, replace = TRUE)
...
for(kk in 1:R){
  boot.sample <- sample(IsBiMSF$RRR, replace = TRUE)
...
for(kk in 1:R){
  boot.sample <- sample(IsMaYSF$RRR, replace = TRUE)
...
a=ggplot(overall, aes(x=Forest.cov, y=ResponseR, shape=Forest.cov)) + 
  ...
  scale_y_continuous(breaks = seq(-2.5,1, by=0.5),
                     labels = seq(-2.5,1, by=0.5),
                     limits = c(-2.5,1), expand = c(0, 0))+
...
Fig2a<-a+
  annotate("text",x=1,y=0.77,label=c("8","","",""), size=3.5)+
  annotate("text",x=2,y=0.11,label=c("25","","",""), size=3.5)+
  annotate("text",x=3,y=0.23,label=c("19","","",""), size=3.5)+
  annotate("text",x=1,y=0.11,label=c("","6","",""), size=3.5)+
  annotate("text",x=2,y=0.02,label=c("","24","",""), size=3.5)+
  annotate("text",x=3,y=0.38,label=c("","11","",""), size=3.5)+
  annotate("text",x=4,y=0.24,label=c("","1","",""), size=3.5)+
  annotate("text",x=1,y=-0.4,label=c("","","6",""), size=3.5)+
  annotate("text",x=2,y=0.31,label=c("","","37",""), size=3.5)+
  annotate("text",x=3,y=0.27,label=c("","","14",""), size=3.5)+
  annotate("text",x=4,y=0.3,label=c("","","1",""), size=3.5)+
  annotate("text",x=1,y=-0.22,label=c("","","","6"), size=3.5)+
  annotate("text",x=2,y=0.34,label=c("","","","30"), size=3.5)+
  annotate("text",x=3,y=0.02,label=c("","","","5"), size=3.5)+
  annotate("text",x=4,y=-0.1,label=c("","","","2"), size=3.5)  
Fig2a #Figure of the bootstrapped effect size of richeness Overall
...
b
Fig2b<-b+
  annotate("text",x=1,y=0.77,label=c("7","","",""), size=3.5)+
  annotate("text",x=2,y=0.23,label=c("21","","",""), size=3.5)+
  annotate("text",x=3,y=0.26,label=c("15","","",""), size=3.5)+
  annotate("text",x=1,y=0.3,label=c("","3","",""), size=3.5)+
  annotate("text",x=2,y=0.05,label=c("","17","",""), size=3.5)+
  annotate("text",x=3,y=0.41,label=c("","8","",""), size=3.5)+
  annotate("text",x=4,y=0.24,label=c("","1","",""), size=3.5)+
  annotate("text",x=1,y=0.18,label=c("","","1",""), size=3.5)+
  annotate("text",x=2,y=0.4,label=c("","","27",""), size=3.5)+
  annotate("text",x=3,y=0.31,label=c("","","6",""), size=3.5)+
  annotate("text",x=1,y=-0.18,label=c("","","","5"), size=3.5)+
  annotate("text",x=2,y=0.32,label=c("","","","17"), size=3.5)+
  annotate("text",x=3,y=-0.11,label=c("","","","3"), size=3.5)+
  annotate("text",x=4,y=-0.11,label=c("","","","2"), size=3.5)  
Fig2b #Figure of the bootstrapped effect size of richeness Neotropical realm
...
c
Fig2c<-c+
  annotate("text",x=1,y=0.30,label=c("1","","",""), size=3.5)+
  annotate("text",x=3,y=-0.26,label=c("1","","",""), size=3.5)+
  annotate("text",x=1,y=-0.25,label=c("","3","",""), size=3.5)+
  annotate("text",x=2,y=0.22,label=c("","3","",""), size=3.5)+
  annotate("text",x=3,y=0.33,label=c("","2","",""), size=3.5)+
  annotate("text",x=1,y=-0.53,label=c("","","3",""), size=3.5)+
  annotate("text",x=2,y=-0.06,label=c("","","2",""), size=3.5)+
  annotate("text",x=3,y=0.15,label=c("","","5",""), size=3.5)+
  annotate("text",x=1,y=-0.39,label=c("","","","1"), size=3.5)+
  annotate("text",x=3,y=0.08,label=c("","","","1"), size=3.5)  
Fig2c #Figure of the bootstrapped effect size of richeness Tropical Dry forest
...
d
Fig2d<-d+
  annotate("text",x=2,y=-1.36,label=c("3","","",""), size=3.5)+
  annotate("text",x=3,y=0.03,label=c("1","","",""), size=3.5)+
  annotate("text",x=2,y=0.06,label=c("","4","",""), size=3.5)+
  annotate("text",x=3,y=0.35,label=c("","1","",""), size=3.5)+
  annotate("text",x=2,y=0.07,label=c("","","6",""), size=3.5)+
  annotate("text",x=3,y=0.49,label=c("","","3",""), size=3.5)+
  annotate("text",x=2,y=0.58,label=c("","","","10"), size=3.5)+
  annotate("text",x=3,y=0.04,label=c("","","","1"), size=3.5)  
Fig2d #Figure of the bootstrapped effect size of richeness Tropical Moist forest
#Now the Afrotropic
...
e
Fig2e<-e+
  annotate("text",x=2,y=-0.47,label=c("1","","",""), size=3.5)+
  annotate("text",x=3,y=0.19,label=c("2","","",""), size=3.5)+
  annotate("text",x=1,y=-1.20,label=c("","","2",""), size=3.5)+
  annotate("text",x=2,y=0.57,label=c("","","2",""), size=3.5)+
  annotate("text",x=4,y=0.30,label=c("","","1",""), size=3.5)+
  annotate("text",x=2,y=0.50,label=c("","","","3"), size=3.5)
Fig2e #Figure of the bootstrapped effect size of richeness Tropical Dry forest
...
f
Fig2f<-f+
  annotate("text",x=1,y=0.77,label=c("6","","",""), size=3.5)+
  annotate("text",x=2,y=0.06,label=c("23","","",""), size=3.5)+
  annotate("text",x=3,y=0.21,label=c("17","","",""), size=3.5)+
  annotate("text",x=1,y=0.16,label=c("","4","",""), size=3.5)+
  annotate("text",x=2,y=0.1,label=c("","22","",""), size=3.5)+
  annotate("text",x=3,y=0.39,label=c("","9","",""), size=3.5)+
  annotate("text",x=4,y=0.24,label=c("","1","",""), size=3.5)+
  annotate("text",x=1,y=-0.31,label=c("","","6",""), size=3.5)+
  annotate("text",x=2,y=0.34,label=c("","","33",""), size=3.5)+
  annotate("text",x=3,y=0.27,label=c("","","9",""), size=3.5)+
  annotate("text",x=4,y=0.3,label=c("","","1",""), size=3.5)+
  annotate("text",x=1,y=-0.16,label=c("","","","1"), size=3.5)+
  annotate("text",x=2,y=0.4,label=c("","","","24"), size=3.5)+
  annotate("text",x=3,y=0.04,label=c("","","","2"), size=3.5)  
Fig2f #Figure of the bootstrapped effect size of richeness Tropical Moist forest
...
g=ggplot(dry, aes(x=Forest.cov, y=ResponseR, shape=Forest.cov)) + 
  ...
  ylab("")+  
  xlab("")+
  geom_rect(aes(xmin=3.6, xmax=4.4, ymin=-Inf, ymax=Inf),alpha=0.5,fill='gray90', data = dry[40000, ])+
  geom_rect(aes(xmin=3.6, xmax=4.4, ymin=-Inf, ymax=Inf),alpha=0.5,fill='gray90', data = dry[80000, ])+
  geom_rect(aes(xmin=0.6, xmax=1.4, ymin=-Inf, ymax=Inf),alpha=0.5,fill='gray90', data = dry[90001, ])+
  geom_rect(aes(xmin=3.6, xmax=4.4, ymin=-Inf, ymax=Inf),alpha=0.5,fill='gray90', data = dry[120000, ])+
  scale_y_continuous(breaks = seq(-2.5,1, by=0.5),
                     labels = seq(-2.5,1, by=0.5),
                     limits = c(-2.5,1), expand = c(0, 0))+
  scale_x_discrete(labels = c("ES \n", 
...
g
Fig2g<-g+
  annotate("text",x=1,y=0.75,label=c("1","","",""), size=3.5)+
  annotate("text",x=2,y=0.66,label=c("2","","",""), size=3.5)+
  annotate("text",x=3,y=0.55,label=c("1","","",""), size=3.5)+
  annotate("text",x=1,y=0.25,label=c("","1","",""), size=3.5)+
  annotate("text",x=2,y=0.34,label=c("","2","",""), size=3.5)+
  annotate("text",x=3,y=0.43,label=c("","1","",""), size=3.5)+
  annotate("text",x=2,y=0.13,label=c("","","4",""), size=3.5)+
  annotate("text",x=3,y=0.32,label=c("","","4",""), size=3.5)+
  annotate("text",x=1,y=-0.80,label=c("","","","3"), size=3.5)+
  annotate("text",x=2,y=0.09,label=c("","","","6"), size=3.5)+
  annotate("text",x=3,y=-0.11,label=c("","","","2"), size=3.5)+
  annotate("text",x=4,y=-0.11,label=c("","","","2"), size=3.5)  
Fig2g #Figure of the bootstrapped effect size of richeness Tropical Dry forest
...
h
Fig2h<-h+
  annotate("text",x=1,y=0.3,label=c("1","","",""), size=3.5)+
  annotate("text",x=3,y=-0.26,label=c("1","","",""), size=3.5)+
  annotate("text",x=1,y=-0.26,label=c("","1","",""), size=3.5)+
  annotate("text",x=3,y=0.33,label=c("","1","",""), size=3.5)+
  annotate("text",x=1,y=-0.53,label=c("","","1",""), size=3.5)+
  annotate("text",x=3,y=0.23,label=c("","","1",""), size=3.5)+
  annotate("text",x=1,y=0.01,label=c("","","","2"), size=3.5)+
  annotate("text",x=3,y=0.08,label=c("","","","1"), size=3.5)
Fig2h #Figure of the bootstrapped effect size of richeness Tropical Dry forest
#Now the Continent
...
Fig2i<-i+
  annotate("text",x=1,y=0.77,label=c("6","","",""), size=3.5)+
  annotate("text",x=2,y=0.12,label=c("23","","",""), size=3.5)+
  annotate("text",x=3,y=0.19,label=c("16","","",""), size=3.5)+
  annotate("text",x=1,y=0.25,label=c("","2","",""), size=3.5)+
  annotate("text",x=2,y=-0.02,label=c("","18","",""), size=3.5)+
  annotate("text",x=3,y=0.41,label=c("","8","",""), size=3.5)+
  annotate("text",x=1,y=-0.16,label=c("","","4",""), size=3.5)+
  annotate("text",x=2,y=0.35,label=c("","","34",""), size=3.5)+
  annotate("text",x=3,y=0.29,label=c("","","8",""), size=3.5)+
  annotate("text",x=4,y=0.3,label=c("","","1",""), size=3.5)+
  annotate("text",x=1,y=-0.1,label=c("","","","2"), size=3.5)+
  annotate("text",x=2,y=0.35,label=c("","","","29"), size=3.5)+
  annotate("text",x=3,y=0.02,label=c("","","","5"), size=3.5)+
  annotate("text",x=4,y=-0.11,label=c("","","","2"), size=3.5)  
Fig2i #Figure of the bootstrapped effect size of richeness in Continent
#Now the Islands
...
j
Fig2j<-j+
  annotate("text",x=1,y=0.59,label=c("2","","",""), size=3.5)+
  annotate("text",x=2,y=0.3,label=c("2","","",""), size=3.5)+
  annotate("text",x=3,y=0.52,label=c("3","","",""), size=3.5)+
  annotate("text",x=1,y=0.16,label=c("","4","",""), size=3.5)+
  annotate("text",x=2,y=0.18,label=c("","6","",""), size=3.5)+
  annotate("text",x=3,y=0.41,label=c("","3","",""), size=3.5)+
  annotate("text",x=4,y=0.24,label=c("","1","",""), size=3.5)+
  annotate("text",x=1,y=-0.90,label=c("","","2",""), size=3.5)+
  annotate("text",x=2,y=-0.06,label=c("","","3",""), size=3.5)+
  annotate("text",x=3,y=0.3,label=c("","","6",""), size=3.5)+
  annotate("text",x=2,y=0.01,label=c("","","","1"), size=3.5)
Fig2j #Figure of the bootstrapped effect size of richeness in Continent


Fig2<-grid.arrange(arrangeGrob(arrangeGrob(Fig2a, Fig2b, Fig2c, Fig2d, Fig2e, nrow=5),
                               arrangeGrob(Fig2f, Fig2g, Fig2h, Fig2i, Fig2j, nrow=5),
                               widths=c(1,1)),
                               left=textGrob("Log Response ratio of species richnes \n (bootstrapped effect size)", 
                               				 rot=90, vjust=1),
                               top=textGrob(""),
                               right=textGrob(""),
                               bottom=textGrob("\nSuccessional stages"))

#Falta poner leyendas
